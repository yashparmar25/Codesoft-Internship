...
try{
   ...
   catch(error)
   {
    ...
    <form onSubmit={handleSubmit}>
        ...
        <ReactQuill theme='snow' placeholder='Write Something....' className='h-72 mt-8 mx-auto w-[47.15rem] dark:bg-gray-800 dark:text-white dark:placeholder:text-white' required
         onChange={(value)=>{
         setFormData({...formData,content:value})   

        }}></ReactQuill>
        <button  className='ml-[15rem] mt-[4rem] h-[2.5rem] w-[8rem] bg-green-500 text-white text-base font-medium rounded-md shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500'>Publish</button>
    </form>
    </div>
  )
}
